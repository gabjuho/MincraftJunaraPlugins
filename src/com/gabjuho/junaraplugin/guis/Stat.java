...
public class Stat {
    ...
    public void open(Player player) {
        ...
        meta1.setLore(Arrays.asList(ChatColor.GREEN + "현재 공격력 스텟: ", "스텟당 공격력이 0.1 증가합니다.", ChatColor.WHITE + "가진 스텟포인트: "));
        item1.setItemMeta(meta1);

        item2 = new ItemStack(Material.TOTEM_OF_UNDYING);
        meta2 = item2.getItemMeta();
        meta2.setDisplayName("체력");
        meta2.setLore(Arrays.asList(ChatColor.GREEN + "현재 체력 스텟: ", "스텟당 체력이 0.5 증가합니다.", ChatColor.WHITE + "가진 스텟포인트: "));
        item2.setItemMeta(meta2);

        item3 = new ItemStack(Material.DIAMOND_CHESTPLATE);
        meta3 = item3.getItemMeta();
        meta3.setDisplayName("방어력");
        meta3.setLore(Arrays.asList(ChatColor.GREEN + "현재 방어력 스텟: ", "스텟당 방어력이 0.1 증가합니다.", ChatColor.WHITE + "가진 스텟포인트: "));
